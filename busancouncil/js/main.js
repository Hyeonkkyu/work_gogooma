...
setInterval(function () {
    ...
    if (previousUrl !== currentUrl || init) {
        ...
        this.document.querySelectorAll('.fixedBtn').forEach(element => {
            ...
            if (nowPage == "#page2") {
                ...
                element.innerHTML = "<a href='https://council.busan.go.kr/council/index' target='_blank'><div><p>세부적인 주요안건 처리현황을 확인하실 수 있습니다.</p><strong>[부산시의회 홈페이지 바로가기]</strong></div></a>";
    ...
    //초기화 시에만 작동하도록 매개변수 지정1
    init = false;
    //페이지 옮김 후 받아온 페이지를 현재 페이지로 갱신1
